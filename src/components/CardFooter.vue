    ...
    <div>
        ...
        <div class="text-center">
            ...
            <a href="https://www.instagram.com/namit_nk/" target="_blank"
                class="m-1 p-1 text-gray-600 text-2xl hover:text-red-600 dark:text-gray-400"><font-awesome-icon
                    icon="fa-brands fa-instagram" /></a>
            <a href="https://github.com/namitkharade" target="_blank"
                class="m-1 p-1 text-gray-600 text-2xl hover:text-black-600 dark:text-gray-400"> <font-awesome-icon
