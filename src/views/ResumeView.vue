<template>
  <div class="ml-20">
    <h1 class="text-4xl font-bold mb-20 mt-20 dark:text-white">Resume</h1>

    <div class="flex dark:text-white">
      <div class="mb-6 text-xl ">
        <p>
          I am <strong class="text-red-600">Namit Kharade</strong>. I am a determined and self-driven software engineer <br>
          with 2 years of experience building optimized and reliable solutions. Currently, <br>
          pursuing Master of Science in Data and Knowledge Engineering at <br>
      ...
      <div class="flex">
        <img src="../assets/imgs/profile.jpg" alt="Photo Namit" class="h-64 w-64 object-cover rounded-full" />
      </div>
    </div>
